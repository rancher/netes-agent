...
type ContainerConfigOperations interface {
	...
	ActionAllocate(*ContainerConfig) (*Instance, error)
	...
	ActionUpdatehealthy(*ContainerConfig) (*Instance, error)

	ActionUpdatereinitializing(*ContainerConfig) (*Instance, error)

	ActionUpdateunhealthy(*ContainerConfig) (*Instance, error)
...
func (c *ContainerConfigClient) ActionAllocate(resource *ContainerConfig) (*Instance, error) {

	resp := &Instance{}

	err := c.rancherClient.doAction(CONTAINER_CONFIG_TYPE, "allocate", &resource.Resource, nil, resp)
...
func (c *ContainerConfigClient) ActionDeallocate(resource *ContainerConfig) (*Instance, error) {

	resp := &Instance{}

	err := c.rancherClient.doAction(CONTAINER_CONFIG_TYPE, "deallocate", &resource.Resource, nil, resp)
...
func (c *ContainerConfigClient) ActionMigrate(resource *ContainerConfig) (*Instance, error) {

	resp := &Instance{}

	err := c.rancherClient.doAction(CONTAINER_CONFIG_TYPE, "migrate", &resource.Resource, nil, resp)
...
func (c *ContainerConfigClient) ActionUpdatehealthy(resource *ContainerConfig) (*Instance, error) {

	resp := &Instance{}

	err := c.rancherClient.doAction(CONTAINER_CONFIG_TYPE, "updatehealthy", &resource.Resource, nil, resp)

	return resp, err
}

func (c *ContainerConfigClient) ActionUpdatereinitializing(resource *ContainerConfig) (*Instance, error) {

	resp := &Instance{}

	err := c.rancherClient.doAction(CONTAINER_CONFIG_TYPE, "updatereinitializing", &resource.Resource, nil, resp)

	return resp, err
}

func (c *ContainerConfigClient) ActionUpdateunhealthy(resource *ContainerConfig) (*Instance, error) {

	resp := &Instance{}

	err := c.rancherClient.doAction(CONTAINER_CONFIG_TYPE, "updateunhealthy", &resource.Resource, nil, resp)
