...
type ScalingGroupOperations interface {
	...
	ActionAddservicelink(*ScalingGroup, *AddRemoveServiceLinkInput) (*Service, error)
	...
	ActionRemoveservicelink(*ScalingGroup, *AddRemoveServiceLinkInput) (*Service, error)

	ActionRestart(*ScalingGroup) (*Service, error)

	ActionRollback(*ScalingGroup, *ServiceRollback) (*Service, error)

	ActionSetservicelinks(*ScalingGroup, *SetServiceLinksInput) (*Service, error)
...
func (c *ScalingGroupClient) ActionAddservicelink(resource *ScalingGroup, input *AddRemoveServiceLinkInput) (*Service, error) {

	resp := &Service{}

	err := c.rancherClient.doAction(SCALING_GROUP_TYPE, "addservicelink", &resource.Resource, input, resp)
...
func (c *ScalingGroupClient) ActionRemoveservicelink(resource *ScalingGroup, input *AddRemoveServiceLinkInput) (*Service, error) {

	resp := &Service{}

	err := c.rancherClient.doAction(SCALING_GROUP_TYPE, "removeservicelink", &resource.Resource, input, resp)
...
func (c *ScalingGroupClient) ActionSetservicelinks(resource *ScalingGroup, input *SetServiceLinksInput) (*Service, error) {

	resp := &Service{}

	err := c.rancherClient.doAction(SCALING_GROUP_TYPE, "setservicelinks", &resource.Resource, input, resp)
