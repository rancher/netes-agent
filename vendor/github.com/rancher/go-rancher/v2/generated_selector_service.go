...
type SelectorServiceOperations interface {
	...
	ActionAddservicelink(*SelectorService, *AddRemoveServiceLinkInput) (*Service, error)
	...
	ActionRemoveservicelink(*SelectorService, *AddRemoveServiceLinkInput) (*Service, error)

	ActionRestart(*SelectorService) (*Service, error)

	ActionRollback(*SelectorService, *ServiceRollback) (*Service, error)

	ActionSetservicelinks(*SelectorService, *SetServiceLinksInput) (*Service, error)
...
func (c *SelectorServiceClient) ActionAddservicelink(resource *SelectorService, input *AddRemoveServiceLinkInput) (*Service, error) {

	resp := &Service{}

	err := c.rancherClient.doAction(SELECTOR_SERVICE_TYPE, "addservicelink", &resource.Resource, input, resp)
...
func (c *SelectorServiceClient) ActionRemoveservicelink(resource *SelectorService, input *AddRemoveServiceLinkInput) (*Service, error) {

	resp := &Service{}

	err := c.rancherClient.doAction(SELECTOR_SERVICE_TYPE, "removeservicelink", &resource.Resource, input, resp)
...
func (c *SelectorServiceClient) ActionSetservicelinks(resource *SelectorService, input *SetServiceLinksInput) (*Service, error) {

	resp := &Service{}

	err := c.rancherClient.doAction(SELECTOR_SERVICE_TYPE, "setservicelinks", &resource.Resource, input, resp)
